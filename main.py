...
def TrainImages():
    ...
    message1.configure(text=res)
    message.configure(text='Total Registrations till now  : ' + str(ID[1]))
...
datef = tk.Label(frame4, text = day+"-"+moth[month]+"-"+year+"  |  ", fg="orange",bg="#262523" ,width=55 ,height=1,font=('times', 22, ' bold '))
